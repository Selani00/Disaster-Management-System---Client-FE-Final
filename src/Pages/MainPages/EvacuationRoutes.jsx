...
const EvacuationRoutes = () => {
  ...
  const [currentLocation, setCurrentLocation] = useState({ lat: 7.1, lng: 80.636696 });
        ...
        <div className="relative mb-5">
          ...
          <div className=" absolute inset-0 py-10 flex-row items-center justify-center text-center">
            ...
            <p className="text-primary font-semibold text-sm md:text-base">
              Your safety is our top priority, and we're here to guide you every step of the way.
            </p>
          </div>
        </div>
        <div className="p-5">
            ...
            <div className="rounded-lg p-5">
              <div className="flex-row md:flex items-center justify-center gap-10">
                <div className="w-full md:w-1/2 text-center">
                  <h1 className="font-semibold text-lg">Select the Parameters</h1>
                  ...
                  <div className="p-5 flex flex-col space-y-4 items-center">
                    <form className="w-full flex flex-col gap-4">
                      <div className="flex justify-start items-center space-x-4">
                        ...
                        <TextInput
                          type="text"
                          value={selectedShelter ? selectedShelter.shelterName : ""}
                          disabled
                          className="w-3/4"
                        />
                      </div>
                      <div className="flex justify-start items-center space-x-4">
                        ...
                        <TextInput
                          type="text"
                          value={selectedShelter ? selectedShelter.location : ""}
                          disabled
                          className="w-3/4"
                        />
                      </div>
                      <div className="flex justify-start items-center space-x-4">
                        ...
                        <TextInput
                          type="text"
                          value={selectedShelter ? selectedShelter.shelterType : ""}
                          disabled
                          className="w-3/4"
                        />
                      </div>
                      <div className="flex justify-start items-center space-x-4">
                        ...
                        <TextInput
                          type="text"
                          value={selectedShelter ? selectedShelter.phoneNumber : ""}
                          disabled
                          className="w-3/4"
                        />
                      </div>
                      <div className="flex justify-start items-center space-x-4">
                        <Label className="text-right w-1/4">Person In Charge</Label>
                        <TextInput
                          type="text"
                          value={selectedShelter ? selectedShelter.personInCharge : ""}
                          disabled
                          className="w-3/4"
                        />
                      </div>
