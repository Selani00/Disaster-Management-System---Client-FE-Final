      ...
      {showModel && (
        ...
        >
          <div className="w-full sm:w-[600px] flex flex-col h-[60vh] sm:h-[450px] border rounded-xl">
            ...
            <div className="bg-gray-300 p-2 rounded w-full overflow-auto flex-grow">
              <div className="relative">
                {messages.map((message, i) => (
                  <div key={i} >
                    <div></div>

                    <div className=" bg-green-300 p-2 rounded-tr-xl rounded-bl-xl rounded-br-xl text-sm mb-2 " style={{ width: 'fit-content' }}>
                      {message.content}
                    </div>
                    
                    <div className=" bg-pink-300 p-2 rounded-tl-xl rounded-bl-xl rounded-br-xl text-sm mb-2" style={{ width: 'fit-content' }}>
                      {message.result}
                    </div>
